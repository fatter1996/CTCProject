...
namespace CTCWindows {
    namespace CASCO {
        ...
        BaseWnd::StationLogDisp* StationViewKSK::CreateTrafficLogManage()
        {
            ...
            menuBarInfo2->pMenu = m_pMenuBar->addMenu("显示"); {
                ...
                menuBarInfo2->addNewAction(this, 1, 1, "站场图"); {
                    ...
                    /*显示内容*/ {
                        ...
                        QAction* pAction2 = menuInfo->addNewSubAction(menuBarInfo2->pMenu, 2, 7, "绝缘节显示", 
                            true, true, Station::MainStation()->IsVisible(Station::VisibleDev::insulationNode));
                        connect(pAction2, &QAction::triggered, [&]() {

                            });

                        QAction* pAction3 = menuInfo->addNewSubAction(menuBarInfo2->pMenu, 2, 8, "列车按钮显示", 
                            true, true, Station::MainStation()->IsVisible(Station::VisibleDev::trainButton));
                        connect(pAction3, &QAction::triggered, [&]() {

                            });

                        QAction* pAction4 = menuInfo->addNewSubAction(menuBarInfo2->pMenu, 2, 9, "调车按钮显示", 
                            true, true, Station::MainStation()->IsVisible(Station::VisibleDev::shuntButton));
                        connect(pAction4, &QAction::triggered, [&]() {

                            });

                        QAction* pAction5 = menuInfo->addNewSubAction(menuBarInfo2->pMenu, 2, 10, "进路序列窗显示", 
                            true, true, Station::MainStation()->IsVisible(Station::VisibleDev::routePlanWnd));
