...
namespace Http {
	...
	public:
		...
		static bool ChangeStaTrain(int stationId, QMap<QString, QByteArray> m_mapTrainValue, QByteArray& btResult);
		...
		static bool ChangeStaTraffRouteData(int nRouteId, QMap<QString, QByteArray> m_mapRouteValue, QByteArray& btResult);
		...
		static bool ChangeStaTrafficLogData(int nLogId,QMap<QString, QByteArray> m_mapLogValue, QByteArray& btResult);
