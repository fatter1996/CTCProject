...
namespace Station {
    namespace Device {
        ...
        StaLamp::StaLamp(QObject* parent)
        {
            m_mapAttribute.insert("lampRect", [=](const QString& strElement) { 
                n_rcLamp = QStringToQRect(strElement); 
            });
        }
        ...
        void StaLamp::Draw(const bool& isMulti)
        {
            DrawLight();
