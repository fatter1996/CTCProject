...
namespace Station {
    namespace Device {
        ...
        void StaHump::DrawText()
        {
            ...
            //ÇÐ¶ÏÍÆËÍ
            m_pPainter.drawText(Scale(QRect(m_ptCutOff, fontMetrics.size(Qt::TextSingleLine, "ÇÐ¶ÏÍÆËÍ"))), "ÇÐ¶ÏÍÆËÍ", QTextOption(Qt::AlignCenter));
            //ÔÊÐíÍÆËÍ
            m_pPainter.drawText(Scale(QRect(m_ptAllow, fontMetrics.size(Qt::TextSingleLine, "ÔÊÐíÍÆËÍ"))), "ÔÊÐíÍÆËÍ", QTextOption(Qt::AlignCenter));
            //ÕÕ²é  
